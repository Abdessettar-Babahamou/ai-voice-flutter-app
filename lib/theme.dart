...
ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleSmall: TextStyle(fontSize: 22, color: AppColor.whiteColor ,fontWeight: FontWeight.w400),
      bodySmall: TextStyle(fontSize: 14, color: AppColor.whiteColor ,fontWeight: FontWeight.w300),
    )
